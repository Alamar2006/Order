...
const MAIN_IMAGE_WRAPPER_CLASSES = "product-pack__main-image-wrapper relative flex items-center justify-center bg-gray-100 border border-[--border] rounded-2xl p-6 lg:p-10 shadow-lg w-full max-w-full min-w-0 box-border overflow-hidden";
    ...
    <div className="product-pack__gallery flex flex-col gap-6 w-full max-w-full min-w-0 box-border overflow-clip animate-[productPackFadeIn_1s_ease-out_0.2s_both]">
      <div className={MAIN_IMAGE_WRAPPER_CLASSES}>
        ...
        >
          ...
          <div className="product-pack__zoom-hint absolute bottom-4 right-4 flex items-center gap-2 px-4 py-2 bg-black/80 border border-white/10 rounded-full text-white/95 text-sm opacity-0 transition-opacity duration-300 pointer-events-none">
